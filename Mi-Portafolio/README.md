...
En `js/script.js` reemplaza este correo por el tuyo real:
...
1. Clona el repositorio o descarga los archivos manteniendo la estructura de carpetas.
2. Abre `index.html` en tu navegador (no necesita servidor ni instalación).

## Despliegue

Publica con **GitHub Pages**:
1. Sube toda la carpeta (`index.html`, `css/`, `js/`, `assets/`) a tu repositorio, respetando la estructura.
2. En **Settings → Pages**, en **Source** selecciona **GitHub Actions** (o "Deploy from a branch" apuntando a `main` / raíz).
3. Espera el despliegue y visita la URL que te da GitHub.
